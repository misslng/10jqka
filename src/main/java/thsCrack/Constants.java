...
public class Constants {
    ...
    public static final int APP_PERMISSION_JOB_ID = 17;
    public static final int BLUETOOTH_COLLECTION_JOB_ID = 6;
    public static final int BROADCACT_ACTION_JOB_ID = 16;
    ...
    public static final String EXTRA_KEY_SUB_IMEI_MD5 = "sub_imei_md5";
